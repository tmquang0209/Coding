...
int main()
{
    ...
    int arrSold[5];
    int total = 0, indexMax = 0, indexMin = 0;
    for (int i = 0; i < 5; i++)
    {
        do
        {
    ...
    cout << "Loai ban chay nhat: " << arrName[indexMax] << "(" << arrSold[indexMax] << ")" << endl;
    cout << "Loai ban cham nhat: " << arrName[indexMin] << "(" << arrSold[indexMin] << ")" << endl;
    return 0;
}