...
int totalCash(char seatingChart[][COL], int fare[]); // TODO: Tinh tong tien kiem duoc
...
{
    cout << "===== Menu =====" << endl;
    cout << "1. Dem so ghe da ban va tong tien\n"
...
void doMenu(char seatingChart[][COL], int fare[])
{
    ...
    do
    {
        ...
        case 1: // TODO: Dem so ghe da dat
            ...
            cout << "Tong tien ban ve: " << totalCash(seatingChart, fare) << endl;
            break;
...
int totalCash(char seatingChart[][COL], int fare[])
{
    int total = 0;
    for (int i = 0; i < ROW; i++)
    {
